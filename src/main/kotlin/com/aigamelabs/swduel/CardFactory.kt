...
object CardFactory {
    ...
    val firstAge = createFromFirstAge()
    val secondAge = createFromSecondAge()
    val thirdAge = createFromThirdAge()
    val guilds = createFromGuilds()
    val wonders = createFromWonders()
    val progressTokens = createFromScience()

    fun getByName(name: String): Card {
        listOf(firstAge, secondAge, thirdAge, guilds, wonders, progressTokens)
                .forEach { deck ->
    ...
    private fun createFromSecondAge() : Vector<Card> {
    ...
    private fun createFromThirdAge() : Vector<Card> {
    ...
    private fun createFromGuilds() : Vector<Card> {
    ...
    private fun createFromWonders() : Vector<Card> {
    ...
    private fun createFromScience() : Vector<Card> {
